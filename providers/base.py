...
def _profile_user_agent() -> str:
    """Return a ``kinqhi-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from kinqhi_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"kinqhi-cli/{_ver}"
    except Exception:
        return "kinqhi-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # kinqhi-cli UA so the catalog endpoint is reachable.
