...
``_check_spotify_available()`` — when the user has not run ``kinqhi auth
spotify``, the tools remain registered (so they appear in ``kinqhi
...
The Spotify auth flow (``kinqhi auth spotify``), CLI plumbing, and docs
