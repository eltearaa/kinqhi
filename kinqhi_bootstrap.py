"""Windows UTF-8 bootstrap for Kinqhi entry points.
...
should be imported at the very top of every Kinqhi entry point
(``kinqhi``, ``kinqhi``, ``kinqhi-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import kinqhi_bootstrap``
# (or ``from kinqhi_bootstrap import apply_windows_utf8_bootstrap``) at
