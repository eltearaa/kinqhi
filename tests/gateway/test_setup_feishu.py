"""Tests for _setup_feishu() in kinqhi_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("kinqhi_cli.config.save_env_value", side_effect=mock_save), \
         patch("kinqhi_cli.config.get_env_value", side_effect=mock_get), \
         patch("kinqhi_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("kinqhi_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("kinqhi_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("kinqhi_cli.cli_output.print_header"), \
         patch("kinqhi_cli.cli_output.print_info"), \
         patch("kinqhi_cli.cli_output.print_success"), \
         patch("kinqhi_cli.cli_output.print_warning"), \
         patch("kinqhi_cli.cli_output.print_error"), \
