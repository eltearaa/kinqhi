...
def store(tmp_path, monkeypatch):
    ...
    ~/.kinqhi/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at kinqhi_state import time, before pytest's KINQHI_HOME monkeypatch
    fires — the autouse fixture's KINQHI_HOME override doesn't help here.)
    """
    import kinqhi_state
