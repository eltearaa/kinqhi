...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves kinqhi_cli.kanban_db on its own
  ...
  - worker logs are captured to KINQHI_HOME/kanban/logs/<task>.log
    ...
    def _spawn(task, workspace):
        ...
        env = {
            **os.environ,
            ...
            "HOME": home,
            "PYTHONPATH": WT,
            "KINQHI_KANBAN_TASK": task.id,
            "KINQHI_KANBAN_WORKSPACE": workspace,
