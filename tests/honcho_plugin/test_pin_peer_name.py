...
Under a gateway (Telegram, Discord, Slack, ...) Kinqhi passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to Kinqhi via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each Kinqhi profile can pin to its own unique peerName.
