...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated KINQHI_HOME, yield (agent, helpers)."""
    ...
    prev_home = os.environ.get("KINQHI_HOME")
    os.environ["KINQHI_HOME"] = os.path.join(test_home, ".hermes")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["KINQHI_HOME"] = prev_home
