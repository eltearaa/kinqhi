...
class TestSpawnEnvIsolation:
    ...
    def test_kanban_worker_adds_only_kanban_writable_root(self, monkeypatch):
        ...
        danger-full-access. Kinqhi passes a narrow app-server config override
        ...
        monkeypatch.setattr(subprocess, "Popen", FakePopen)
        monkeypatch.setenv("HOME", "/users/alice")
        monkeypatch.setenv("KINQHI_HOME", "/users/alice/.hermes/profiles/backend-worker")
        monkeypatch.setenv("KINQHI_KANBAN_TASK", "t_smoke")
        monkeypatch.setenv(
            "KINQHI_KANBAN_DB",
