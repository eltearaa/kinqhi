...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (KINQHI_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via KINQHI_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in KINQHI_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from kinqhi_cli.providers import KINQHI_OVERLAYS
        assert "bedrock" in KINQHI_OVERLAYS

    def test_bedrock_overlay_transport(self):
        from kinqhi_cli.providers import KINQHI_OVERLAYS
        assert KINQHI_OVERLAYS["bedrock"].transport == "bedrock_converse"

    def test_bedrock_overlay_auth_type(self):
        from kinqhi_cli.providers import KINQHI_OVERLAYS
        assert KINQHI_OVERLAYS["bedrock"].auth_type == "aws_sdk"
