"""Tests for the specifier module + `kinqhi kanban specify` CLI surface.
...
from kinqhi_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `kinqhi kanban …` argparse surface directly."""
