...
from kinqhi_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(kinqhi_home, memory_text="", user_text=""):
    mem_dir = kinqhi_home / "memories"
...
def _seed_skill(kinqhi_home, name, description):
    skill_dir = kinqhi_home / "skills" / "demo" / name
