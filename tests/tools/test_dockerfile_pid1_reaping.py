...
def test_dockerfile_installs_tui_dependencies(dockerfile_text):
    ...
    # resolve dependencies. The bundled ``kinqhi-ink`` workspace package is
    ...
    assert "ui-tui/packages/kinqhi-ink/" in dockerfile_text
...
def test_dockerfile_materializes_local_tui_ink_package(dockerfile_text):
    # ``kinqhi-ink`` is a bundled workspace package referenced from
    ...
    assert "ui-tui/packages/kinqhi-ink/" in dockerfile_text, (
        "Dockerfile must COPY the bundled kinqhi-ink workspace package "
