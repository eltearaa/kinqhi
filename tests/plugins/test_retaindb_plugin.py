...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure KINQHI_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", kinqhi_home=str(tmp_path / ".hermes"))
    ...
    def test_initialize_profile_project(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", kinqhi_home=profile_home)
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("KINQHI_HOME", str(kinqhi_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", kinqhi_home=str(kinqhi_home))
        return p
