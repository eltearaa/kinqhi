...
Covers three layers:
  * ``kinqhi_cli.kanban_db`` accessors (add/list/get/delete + path helpers)
...
def test_attachments_root_is_per_board(kanban_home, monkeypatch):
    ...
    monkeypatch.delenv("KINQHI_KANBAN_ATTACHMENTS_ROOT", raising=False)
...
def test_attachments_root_env_override(kanban_home, monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("KINQHI_KANBAN_ATTACHMENTS_ROOT", str(override))
