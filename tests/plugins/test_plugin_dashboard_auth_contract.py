...
_FORBIDDEN = "__KINQHI_SESSION_TOKEN__"
...
def test_there_are_plugin_bundles_to_check() -> None:
    ...
    # kanban + kinqhi-achievements are bundled today; assert at least one is
