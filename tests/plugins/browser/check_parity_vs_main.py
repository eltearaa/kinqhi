...
Run from the PR worktree:
    ...
    cd ~/.kinqhi/kinqhi/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.kinqhi/kinqhi``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.kinqhi/kinqhi
PR_DIR = REPO_ROOT  # the worktree we're in
assert (MAIN_DIR / "tools" / "browser_tool.py").exists(), (
    f"MAIN_DIR={MAIN_DIR} doesn't look like a kinqhi checkout"
)
...
# Isolated KINQHI_HOME for the config write.
