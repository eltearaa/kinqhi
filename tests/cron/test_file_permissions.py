...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("kinqhi_cli.config.get_config_path", return_value=config_path), \
             patch("kinqhi_cli.config.ensure_kinqhi_home"):
    ...
    def test_ensure_kinqhi_home_sets_0700(self):
