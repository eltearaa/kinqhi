...
One ``CDPSupervisor`` runs per Kinqhi ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "kinqhi-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://kinqhi-dialog-bridge.invalid/";
