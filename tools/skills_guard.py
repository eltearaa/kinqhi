...
Trust levels:
  - builtin:   Ships with Kinqhi. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.kinqhi/\.env|\~/\.kinqhi/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Kinqhi secrets file"),
    ...
    (r'\.kinqhi/config\.yaml|\.kinqhi/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Kinqhi configuration files directly"),
...
# scan. `.skillignore` is the Kinqhi-native name; `.clawhubignore` is honored
