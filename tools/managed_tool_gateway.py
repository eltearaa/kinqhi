...
def auth_json_path():
    """Return the Kinqhi auth store path, respecting KINQHI_HOME overrides."""
    return get_kinqhi_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`kinqhi tools`, banner/status paint, provider
