...
(3 SDK retries x 3 Kinqhi retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_kinqhi_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".kinqhi")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Kinqhi, ...) behind one endpoint.  A 429 can mean either:
