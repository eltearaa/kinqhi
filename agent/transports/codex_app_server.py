...
projection into Kinqhi' display, approval bridging, transcript projection into
...
"codex_app_server"`. Kinqhi' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("KINQHI_KANBAN_TASK"):
            kanban_db = spawn_env.get("KINQHI_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "KINQHI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("KINQHI_HOME", os.path.expanduser("~/.kinqhi")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "kinqhi",
        client_title: str = "Kinqhi",
