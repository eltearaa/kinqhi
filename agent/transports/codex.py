...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Kinqhi's web-provider config and
        ...
        # native search engine for xAI sessions instead of Kinqhi's
        # configured web provider (Tavily/etc.), and those results bypass
        # Kinqhi's tool-trace / citation plumbing (they arrive baked into the
