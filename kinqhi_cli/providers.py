"""
Single source of truth for provider identity in Kinqhi.
...
2. **Kinqhi overlays** — transport type, auth patterns, aggregator flags,
...
# -- Kinqhi overlay ----------------------------------------------------------
# Kinqhi-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class KinqhiOverlay:
    """Kinqhi-specific provider metadata layered on top of models.dev."""
...
KINQHI_OVERLAYS: Dict[str, KinqhiOverlay] = {
    "openrouter": KinqhiOverlay(
    ...
    "openai-codex": KinqhiOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://chatgpt.com/backend-api/codex",
    ),
    "openai-api": KinqhiOverlay(
        transport="codex_responses",
        base_url_override="https://api.openai.com/v1",
        base_url_env_var="OPENAI_BASE_URL",
    ),
    "xai-oauth": KinqhiOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://api.x.ai/v1",
        base_url_env_var="XAI_BASE_URL",
    ),
    "qwen-oauth": KinqhiOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="https://portal.qwen.ai/v1",
        base_url_env_var="KINQHI_QWEN_BASE_URL",
    ),
    "google-gemini-cli": KinqhiOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="cloudcode-pa://google",
    ),
    "lmstudio": KinqhiOverlay(
        transport="openai_chat",
        auth_type="api_key",
    ...
    "copilot-acp": KinqhiOverlay(
        transport="codex_responses",
        auth_type="external_process",
        base_url_override="acp://copilot",
        base_url_env_var="COPILOT_ACP_BASE_URL",
    ),
    "github-copilot": KinqhiOverlay(
        transport="openai_chat",
        extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN"),
    ),
    "anthropic": KinqhiOverlay(
    ...
    "kimi-for-coding": KinqhiOverlay(
        transport="openai_chat",
        base_url_env_var="KIMI_BASE_URL",
    ),
    "stepfun": KinqhiOverlay(
        transport="openai_chat",
        extra_env_vars=("STEPFUN_API_KEY",),
        base_url_override="https://api.stepfun.ai/step_plan/v1",
        base_url_env_var="STEPFUN_BASE_URL",
    ),
    "minimax": KinqhiOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_BASE_URL",
    ),
    "minimax-oauth": KinqhiOverlay(
        transport="anthropic_messages",
        auth_type="oauth_external",
        base_url_override="https://api.minimax.io/anthropic",
    ),
    "minimax-cn": KinqhiOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_CN_BASE_URL",
    ),
    "deepseek": KinqhiOverlay(
        transport="openai_chat",
        base_url_env_var="DEEPSEEK_BASE_URL",
    ),
    "alibaba": KinqhiOverlay(
        transport="openai_chat",
        base_url_env_var="DASHSCOPE_BASE_URL",
    ),
    "alibaba-coding-plan": KinqhiOverlay(
        transport="openai_chat",
        base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL",
    ),
    "opencode": KinqhiOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_ZEN_BASE_URL",
    ),
    "opencode-go": KinqhiOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "huggingface": KinqhiOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="HF_BASE_URL",
    ),
    "novita": KinqhiOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "nvidia": KinqhiOverlay(
        transport="openai_chat",
        base_url_override="https://integrate.api.nvidia.com/v1",
        base_url_env_var="NVIDIA_BASE_URL",
    ),
    "xiaomi": KinqhiOverlay(
        transport="openai_chat",
        base_url_env_var="XIAOMI_BASE_URL",
    ),
    "tencent-tokenhub": KinqhiOverlay(
        transport="openai_chat",
    ...
    "azure-foundry": KinqhiOverlay(
        transport="openai_chat",  # default; overridden by api_mode in config
        base_url_env_var="AZURE_FOUNDRY_BASE_URL",
    ),
    "bedrock": KinqhiOverlay(
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "kinqhi", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Kinqhi overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + Kinqhi overlay
    ...
    overlay = KINQHI_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + kinqhi extra
    ...
    if overlay is not None:
        # Kinqhi-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in KINQHI_OVERLAYS
    if provider == "bedrock":
