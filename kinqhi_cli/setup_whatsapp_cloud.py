...
Entry point: ``kinqhi whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``kinqhi_cli/main.py``).
...
Kinqhi gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Kinqhi to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Kinqhi needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Kinqhi gateway in another terminal:")
    print("         kinqhi gateway")
    print()
    ...
    print()
    print("  Docs: https://kinqhi.nousresearch.com/docs/user-guide/")
