...
Usage:
    kinqhi pairing list              # Show all pending + approved users
    kinqhi pairing approve <platform> <code>  # Approve a pairing code
    kinqhi pairing revoke <platform> <user_id> # Revoke user access
    kinqhi pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle kinqhi pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: kinqhi pairing {list|approve|revoke|clear-pending}")
        print("Run 'kinqhi pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.kinqhi/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'kinqhi pairing list' to see pending codes.\n")
