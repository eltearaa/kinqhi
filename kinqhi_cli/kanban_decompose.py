...
Invoked by ``kinqhi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Kinqhi board.
...
def _profile_author() -> str:
    """Mirror of ``kinqhi_cli.kanban._profile_author``."""
    return (
