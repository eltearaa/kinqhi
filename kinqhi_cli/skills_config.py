"""
Skills configuration for Kinqhi.
`kinqhi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.kinqhi/config.yaml under:
...
from kinqhi_cli.config import cfg_get, load_config, save_config
from kinqhi_cli.colors import Colors, color
from kinqhi_cli.platforms import PLATFORMS as _PLATFORMS
