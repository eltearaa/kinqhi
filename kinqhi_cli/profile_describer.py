...
Used by ``kinqhi profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``kinqhi_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Kinqhi kanban board.
...
Rules:
  ...
  - Never write "Kinqhi profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_kinqhi_home())
        else:
