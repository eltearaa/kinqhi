"""``kinqhi tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'kinqhi tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # kinqhi tools list [--platform cli]
    ...
    # kinqhi tools disable <name...> [--platform cli]
    ...
    # kinqhi tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `kinqhi tools` runs after you pick a provider that\n"
