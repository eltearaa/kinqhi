"""
Kinqhi CLI - Unified command-line interface for Kinqhi.

Provides subcommands for:
- kinqhi chat          - Interactive chat (same as ./kinqhi)
- kinqhi gateway       - Run gateway in foreground
- kinqhi gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `kinqhi setup` on a fresh Pi.
    ...
    kinqhi_cli/stdio.py::configure_windows_stdio() runs later from the entry
