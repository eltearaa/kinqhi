"""
Cron job scheduling system for Kinqhi.
...
Cron jobs are executed automatically by the gateway daemon:
    kinqhi gateway install    # Install as a user service
    sudo kinqhi gateway install --system  # Linux servers: boot-time system service
    kinqhi gateway            # Or run in foreground
