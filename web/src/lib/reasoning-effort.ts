 ...
 *
 * Values mirror kinqhi_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Kinqhi default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Kinqhi' default when unset). */
