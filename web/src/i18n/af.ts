...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateKinqhi: "Werk Kinqhi op",
    updatingKinqhi: "Besig om Kinqhi op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Kinqhi-inproppe op (`hermes plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.kinqhi/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.kinqhi/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.kinqhi/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Kinqhi-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Kinqhi-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Kinqhi meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Kinqhi 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Kinqhi skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
