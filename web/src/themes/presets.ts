 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `kinqhi_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Kinqhi Teal",
  description: "Classic dark teal — the canonical Kinqhi look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Kinqhi look, ported from the
 ...
 * nousnet-web's <body> is white; kinqhi's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Kinqhi Teal (Large)",
  description: "Kinqhi Teal with bigger fonts and roomier spacing",
