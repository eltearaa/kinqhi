 ...
 *
 * Plugins call window.__KINQHI_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__KINQHI_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__KINQHI_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__KINQHI_PLUGIN_SDK__ = {
    ...
    // window.__KINQHI_SESSION_TOKEN__ directly.
    authedFetch,
