/**
 * Kinqhi Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__KINQHI_PLUGIN_SDK__`` and
 * ``window.__KINQHI_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__KINQHI_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``KinqhiPluginSDK["sdkVersion"]`` (and the
 ...
 * of calling ``fetch`` with a hand-read ``window.__KINQHI_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__KINQHI_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__KINQHI_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface KinqhiPluginSDK {
...
declare global {
  interface Window {
    __KINQHI_PLUGIN_SDK__?: KinqhiPluginSDK;
    __KINQHI_PLUGINS__?: PluginRegistry;
  }
}
