...
VERSION_FILE = REPO_ROOT / "kinqhi_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "kinqhi@marian.local": "Schrotti77",
    ...
    "274096618+kinqhi-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "kinqhi@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (KINQHI_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (KINQHI_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: kinqhi-eval community link)
    ...
    "vigo@kinqhi": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.kinqhi@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Kinqhi runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level KINQHI_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Kinqhi
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"kinqhi[acp]=={semver}"
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/kinqhi",
    ...
    lines.append(f"# Kinqhi v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Kinqhi. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Kinqhi Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Kinqhi Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Kinqhi v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Kinqhi v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Kinqhi v{new_version} ({calver_date})' "
