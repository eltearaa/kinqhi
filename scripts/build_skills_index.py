#!/usr/bin/env python3
"""Build the Kinqhi Skills Index — a centralized JSON catalog of all skills.
...
`kinqhi skills search/install` can use it without hitting the GitHub API.
...
# Ensure KINQHI_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Kinqhi Skills Index...", flush=True)
