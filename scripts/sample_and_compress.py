...
DEFAULT_DATASETS = [
    ...
    "NousResearch/kinqhi-megascience-sft1",
    "NousResearch/Kinqhi-Thinking-GLM-4.7-SFT2",
    "NousResearch/Kinqhi-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-kinqhi"
]
