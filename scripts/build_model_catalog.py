#!/usr/bin/env python3
"""Build the Kinqhi Model Catalog — a centralized JSON manifest of curated models.
...
Kinqhi CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Kinqhi release.
...
# Ensure KINQHI_HOME is set for imports that touch it at module level.
os.environ.setdefault("KINQHI_HOME", os.path.join(os.path.expanduser("~"), ".kinqhi"))

from kinqhi_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "kinqhi repo",
            "docs": "https://kinqhi.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
